...
| ----------------------- | -------------------------------------------------- | -------------------------------------------------------------------------------- |
| `PARITY_TS_URL`         | `ws://localhost:4858/sync/v50/connect`             | harness-coverage, harness-advance-coverage                                       |
| `PARITY_RS_URL`         | `ws://localhost:4868/sync/v50/connect`             | harness-coverage, harness-advance-coverage                                       |
...
PARITY_TS_URL=ws://localhost:4858/sync/v50/connect \
